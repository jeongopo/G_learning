export default class S_Loading extends Phaser.Scene {
  ...
  create() {
    ...
    const selectText = this.add
      .text(this.cameras.main.centerX, 100, "얼굴이 화면 한가운데에 있도록 조정해주세요!", {
    ...
    */
    ...
    output_canvas.style =
    "position: absolute; top: 50%; left: 50%; width:40%; transform: translate(-50%,-50%); border-radius: 15px; border: 5px solid black;";
    this.startGame();
  }
}
