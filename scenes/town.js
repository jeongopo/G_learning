...
export default class S_Town extends Phaser.Scene {
  ...
  create() {
    ...
    this.UserNameText = this.add.text(
      330,
      80,
      this.scene.get("userdata").username,
      {
        fontFamily: "Noto Sans KR",
        fill: "#000000",
        fontSize: "32px",
    ...
    this.coinText = this.add
      .text(1100, 50, "💰 Coin : " + this.scene.get("userdata").gold, {
        fontFamily: "Noto Sans KR",
        fill: "#FFF",
        fontSize: "40px",
        stroke: "#7E972E",
    ...
    if (this.ShopBtn == null) {
      this.ShopBtn = this.add.text(700, 50, "상점 열기", {
        fontFamily: "Noto Sans KR",
        fill: "#000000",
        fontSize: "50px",
        fontWeight: "bold",
    ...
    this.GameBtn = this.add.text(700, 700, "게임 시작", {
      fontFamily: "Noto Sans KR",
      fill: "#000000",
      fontSize: "50px",
      fontWeight: "bold",
