...
export default class S_SoundManager extends Phaser.Scene {
    constructor() {
        ...
        this.playSE = (key)=>{
            switch(key){
                case "CLICK" : this.SE_Source[0].play();
                                break;
                case "BACK" : this.SE_Source[1].play();
                                break;
                case "BUY" : this.SE_Source[2].play();
                            break;
                case "FINISHGAME" : this.SE_Source[3].play();
                            break;
            }
        }
    }
    ...
    preload(){
        this.load.audio("BGM1", "./assets/bgm/BGM_Caketown.mp3");
    ...
    create(){
        this.BGM_Source = this.sound.add("BGM1", {
            loop: false,
          });
